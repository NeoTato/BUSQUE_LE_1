...
game_library = {
    ...
    "Mortal Kombat": {"quantity": 4, "cost": 1}
...
def rent_game(username):
    if user_accounts[username]["balance"] == 0:
        print("Current balance is 0.00. Please topup first before renting a game.")
                ...
                while True:
                    ...
                    if 1 <= game_number <= len(game_library.keys()):
                        ...
                        while True:
                            ...
                            print("--------------------------------------------------------------------")
                            print(f"{game}: ")
                            for info, value in game_library[game].items():
                                print(f"\t{info}: {value}")
                            ...
                            if option == 1:
                                ...
                                if new_name == "":
                                    return
                                if new_name.lower() in (name.lower() for name in game_library):
                                ...
                                if new_quantity < 0:
                                    print("Enter 0 or a positive integer only.")
                                    input("\nPress ENTER to continue.")
                                else:
...
def admin_login():
    ...
    while True:
        username = input("Enter admin username (leave blank to exit): ")
        if username == "":
            break
    ...
    while True:
        try:
            ...
            if choice == 1:
                ...
                os.system('cls')
                home = "Returning to login window..."
                for char in home:
                    print(char, end="")
                    time.sleep(0.02)
                print("\n")
...
def display_game_inventory():
    ...
    if not user_accounts.items():
        print("\nThere are currently no rented games.")
    else:  
...
def check_credentials():
    if not user_accounts:
        ...
        print("Login Window")
        while True:
            username = input("Enter username (leave blank to exit): ")
            if username == "":
                break
